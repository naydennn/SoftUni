...
public class LoaderTest {
    ...
    public void customTest() {
        ...
        loader.add(new User(1,1));
        loader.add(new User(2,2));
        loader.add(new User(3,3));
        loader.add(new User(4,4));
        loader.add(new User(5,5));

        Entity extract = loader.extract(2);
        assertEquals(2,extract.getId());
        loader.extract(1);
        assertEquals(3,loader.root.entity.getId());
        User user1 = new User(1, 1);
        User user2 = new User(2, 2);
        loader.add(user1);
        loader.add(user2);
        loader.swap(user1, user2);
        assertEquals(1,loader.tail.entity.getId());

        Entity expectedEntity = new User(3,3);
        Entity actualEntity = loader.find(expectedEntity);
