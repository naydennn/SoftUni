...
// Audi S4 (2005)
        ...
        // Initialize the repository
        Dealership op = new Dealership("Autofest", 5);

// Initialize entity
        Car sc = new Car("Volvo", "XC70", 2010);
...
// Remove Car
        ...
        Car p = new Car("Peugeot", "307", 2011);
        Car a = new Car("Audi", "S4", 2005);

        dealership.add(peugeot);
        dealership.add(audi);

// Get Latest Car
        Car l = dealership.getLatestCar();
        System.out.println(latestCar); // Peugeot 307 (2011)

// Get Car
        Car v = dealership.getCar("Audi", "S4");
        System.out.println(audiS4); // Audi S4 (2005)
